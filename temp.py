...
class Player:
    def __init__(
        self, name, health
    ):  # you dont need the health as an input unless you want to define this for every player... you are better off
...
def run():
    ...
    while p1.health > 0:
        ...
        if choice == "1":
            ...
            print(
                f"{narrator}YOU COWARD! You miserable worm! The Coding Village was counting on you to fight!"
            )
            break
        else:
